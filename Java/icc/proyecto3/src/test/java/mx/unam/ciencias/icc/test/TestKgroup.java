...
/**
 * Clase para pruebas unitarias de la clase Kgroup.
 */
public class TestKgroup {
    ...
    /**
     * Genera una generacion aleatoria en el intervalo.
     * @return una generacion aleatoria en el intervalo.
     */
    public static int generationAleatorio() {
        int g = random.nextInt(4 - 1 + 1) + 1;
        return g;
    }
     ...
     * @return una cancón aleatoria.
     */
    public static String songAleatorio() {
    ...
    public static Kgroup kgroupAleatorio() {
        return new Kgroup(nameAleatorio(), yearAleatorio(), generationAleatorio(),
                typeAleatorio(), memberAleatorio(), genreAleatorio(), labelAleatorio(),
                songAleatorio(), reviewAleatorio());
    }

    /**
     * Genera un grupo de kpop aleatorio con un año debut aleatorio dado.
     * @return un grupo de kpop aleatorio con un año debut aleatorio dado.
     */
    public static Kgroup kgroupAleatorio(int year) {
        return new Kgroup(nameAleatorio(), year, generationAleatorio(), typeAleatorio(),
    ...
    @Test public void testConstructor() {
        ...
        Assert.assertTrue(kgroup.getSong().equals(song));
    ...
    @Test public void testGetName() {
        ...
        String song = songAleatorio();
        double review = reviewAleatorio();
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.getName().equals(name));
    ...
    /** 
     * Prueba unitaria para {@link Kgroup#nameProperty}
     */
    @Test public void testNameProperty() {
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.nameProperty().get().equals(name));
    }
    ...
    /** 
     * Prueba unitaria para {@link Kgroup#yearProperty}
     */
    @Test public void testYearProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.yearProperty().get() == year);
    }
    ...
    @Test public void testSetGeneration() {
        ...
        int year = yearAleatorio();
        int generation = generationAleatorio();
        int newGeneration = generation + 3;
        String type = typeAleatorio();
        int members = memberAleatorio();
        String genre = genreAleatorio();
        String label = labelAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.getGeneration() == generation);
        Assert.assertFalse(kgroup.getGeneration() == generation + 3);
        kgroup.setGeneration(newGeneration);
        Assert.assertFalse(kgroup.getGeneration() == generation);
        Assert.assertTrue(kgroup.getGeneration() == newGeneration);
    }
    
    /** 
     * Prueba unitaria para {@link Kgroup#generationProperty}
     */
    @Test public void testGenerationProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.generationProperty().get() == generation);
    }
    ...
    /** 
     * Prueba unitaria para {@link Kgroup#typeProperty}
     */
    @Test public void testTypeProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.typeProperty().get().equals(type));
    }
    ...
    /** 
     * Prueba unitaria para {@link Kgroup#membersProperty}
     */
    @Test public void testMembersProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.membersProperty().get() == members);
    }
    ...
    /** 
     * Prueba unitaria para {@link Kgroup#genreProperty}
     */
    @Test public void testGenreProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.genreProperty().get().equals(genre));
    }
    ...
    /** 
     * Prueba unitaria para {@link Kgroup#labelProperty}
     */
    @Test public void testLabelProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.labelProperty().get().equals(label));
    }

    /**
     * Prueba unitaria para {@link Kgroup#getSong}.
     */
    @Test public void testGetSong() {
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.getSong().equals(song));
        Assert.assertFalse(kgroup.getSong().equals(song + " B"));
    }

    /**
     * Prueba unitaria para {@link Kgroup#setSong}.
     */
    @Test public void testSetSong() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        String label = labelAleatorio();
        String song = songAleatorio();
        String newSong = song + " B";
        double review = reviewAleatorio();
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.getSong().equals(song));
        Assert.assertFalse(kgroup.getSong().equals(song + " B"));
        kgroup.setSong(newSong);
        Assert.assertFalse(kgroup.getSong().equals(song));
        Assert.assertTrue(kgroup.getSong().equals(newSong));
    }

    /** 
     * Prueba unitaria para {@link Kgroup#songProperty}
     */
    @Test public void testSongProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.songProperty().get().equals(song));
    }
    ...
    /** 
     * Prueba unitaria para {@link Kgroup#reviewProperty}
     */
    @Test public void testReviewProperty() {
        String name = nameAleatorio();
        int year = yearAleatorio();
        int generation = generationAleatorio();
        String type = typeAleatorio();
        ...
        kgroup = new Kgroup(name, year, generation, type,
                members, genre, label, song, review);
        Assert.assertTrue(kgroup.reviewProperty().get() == review);
    }
    ...
    @Test public void testToString() {
        ...
        String cadena = String.format("Nombre : %s\n" +
                             ...
                             name, year, generation, type, members, genre, label, song,
                             review);
    ...
    @Test public void testEquals() {
        ...
        kgroup = new Kgroup(name, year, generation,
                type, members, genre, label, song, review);
        Kgroup igual = new Kgroup(new String(name), year, generation, new String(type)
                , members, new String(genre), new String(label), new String(song), review);
        Assert.assertTrue(kgroup.equals(igual));
        String anotherName = name + " Yooa";
        int anotherYear = year + 1;
        int anotherGeneration = generation + 2;
        String anotherType = type + " yein";
        int anotherMembers = members + 3;
        String anotherGenre = genre + " psychedelic";
        String anotherLabel = label + " FC";
        String anotherSong = song + " Fireworks";
        double anotherReview = review + 2.5;
        Kgroup distinto = 
            new Kgroup(anotherName, anotherYear, anotherGeneration, anotherType,
                       anotherMembers, anotherGenre, anotherLabel,
                       anotherSong, anotherReview);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, anotherYear, generation, type,
                              members, genre, label, song, review);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, year, anotherGeneration, type,
                              members, genre, label, song, review);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, year, generation, anotherType, members,
                            genre, label, song, review);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, year, generation, type, anotherMembers,
                              genre, label, song, review);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, year, generation, type, members,
                              anotherGenre, label, song, review);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, year, generation, type, members,
                              genre, anotherLabel, song, review);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, year, generation, type, members,
                              genre, label, anotherSong, review);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(name, year, generation, type, members,
                              genre, label, song, anotherReview);
        Assert.assertFalse(kgroup.equals(distinto));
        distinto = new Kgroup(anotherName, anotherYear, anotherGeneration,
                        anotherType, anotherMembers, anotherGenre,
                        anotherLabel, anotherSong, anotherReview);
        Assert.assertFalse(kgroup.equals(distinto));
        Assert.assertFalse(kgroup.equals("hola mundo"));
    ...
    @Test public void testActualiza() {
        ...
        Assert.assertFalse(kgroup.nameProperty() == k.nameProperty());
        Assert.assertFalse(kgroup.yearProperty() == k.yearProperty());
        Assert.assertFalse(kgroup.generationProperty() == k.generationProperty());
        Assert.assertFalse(kgroup.typeProperty() == k.typeProperty());
        Assert.assertFalse(kgroup.membersProperty() == k.membersProperty());
        Assert.assertFalse(kgroup.genreProperty() == k.genreProperty());
        Assert.assertFalse(kgroup.labelProperty() == k.labelProperty());
        Assert.assertFalse(kgroup.songProperty() == k.songProperty());
        Assert.assertFalse(kgroup.reviewProperty() == k.reviewProperty());
    ...
    @Test public void testCasa() {
        ...
        String z = kgroup.getSong();
        int x = kgroup.getSong().length();
        Assert.assertTrue(kgroup.casa(CampoKgroup.SONG, z));
        z = kgroup.getSong().substring(0, x/2);
        Assert.assertTrue(kgroup.casa(CampoKgroup.SONG, z));
        z = kgroup.getSong().substring(x/2, x);
        Assert.assertTrue(kgroup.casa(CampoKgroup.SONG, z));
        z = kgroup.getSong().substring(x/3, 2*(x/3));
        Assert.assertTrue(kgroup.casa(CampoKgroup.SONG, z));
        Assert.assertFalse(kgroup.casa(CampoKgroup.SONG, ""));
        Assert.assertFalse(kgroup.casa(CampoKgroup.SONG, "VVV"));
        Assert.assertFalse(kgroup.casa(CampoKgroup.SONG, 
                                       Integer.valueOf(1000)));
        Assert.assertFalse(kgroup.casa(CampoKgroup.SONG, null));
