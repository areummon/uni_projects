...
public abstract class BaseDeDatos<R extends Registro<R, C>, C extends Enum> {
    ...
    public void agregaRegistro(R registro) {
        ...
        escuchas.forEach(e -> e.baseDeDatosModificada(EventoBaseDeDatos.REGISTRO_AGREGADO,registro,null));
    }
    ...
    public void eliminaRegistro(R registro) {
        ...
        escuchas.forEach(e -> e.baseDeDatosModificada(EventoBaseDeDatos.REGISTRO_ELIMINADO,registro,null));
    }
    ...
    public void modificaRegistro(R registro1, R registro2) {
        if (registro1 == null || registro2 == null)
            throw new IllegalArgumentException("Los registros son nulos");
        for (R registro : registros)
            if (registro1.equals(registro)) {
                escuchas.forEach(e -> e.baseDeDatosModificada(EventoBaseDeDatos.REGISTRO_MODIFICADO,registro1,registro2));
    ...
    public void limpia() {
        registros.limpia();
        escuchas.forEach(e -> e.baseDeDatosModificada(EventoBaseDeDatos.BASE_LIMPIADA,null,null));
    }
    ...
    public void carga(BufferedReader in) throws IOException {
        ...
        while((linea = in.readLine()) != null) {
            ...
            try {
                ...
                throw new IOException("Error de entrada/salida: '" + linea +"'"); 
            }
        }
    }
    ...
    public Lista<R> buscaRegistros(C campo, Object valor) {
        Lista<R> registrosCaza = new Lista<>();
        for (R registro : registros) {
            try{
                if (registro.casa(campo, valor))
                    registrosCaza.agregaInicio(registro);
